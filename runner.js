...
k.ENVIRONMENT_IS_PTHREAD || k.$ww || function(a) {
    function b(n, p, q, u) {
        if ("object" === typeof process && "object" === typeof process.versions && "string" === typeof process.versions.node)
            ...
            w.onprogress = function(r) {
                ...
                r.total && (A = r.total);
                if (r.loaded) {
                    w.Ai ? k.vj[n].loaded = r.loaded : (w.Ai = !0,
                        k.vj || (k.vj = {}),
                        k.vj[n] = {
                            loaded: r.loaded,
                            total: A
                    ...
                    k.setStatus && k.setStatus(`Downloading data... (" + C + "/" + r + ")`)
                } else
    ...
    "remote_package_size": 1162247,
    "package_uuid": "2cab2af2-ec18-4c4e-808e-154335cd87c4"
});
